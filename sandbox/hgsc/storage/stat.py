'''This program calculate the storage breakdown.

The input data is in the "out" dir, named as path.YYYYmmdd.log
The output is printed with a breakdown by snfs and subdirs.
'''
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1:
        print('python3  {}  [time_stamp]'.format(__file__))
        sys.exit(0)
